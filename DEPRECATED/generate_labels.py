...
for d in glob.iglob(dirpath + "/*/extracted"):
	...
	pub_date = metadata['publishDates'][0]
	...
	for f in os.listdir(d):
		...
		newpath = targetpath + pub_date + "/" + htid + "_" + page + "." + ext 
